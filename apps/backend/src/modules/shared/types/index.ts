...
import type { orderTable } from '@shared/db/schemas/order.model';
import type { premiumTable, starQuantity, starTable } from '@shared/db/schemas/services.model';
import type { userTable } from '@shared/db/schemas/user.model';
...
export type InsertOrderTable = InferInsertModel<typeof orderTable>
export type SelectOrderTable = InferSelectModel<typeof orderTable>;

export type SelectPremiumTable = InferSelectModel<typeof premiumTable>;
export type InsertPremiumTable = InferInsertModel<typeof premiumTable>;

export type UserTable = InferSelectModel<typeof userTable>;
export type SelectUserTable = Omit<UserTable, 'role'> & {roles : InitRoles}
export type InsertUser = InferInsertModel<typeof userTable>;

export type InsertStarTable = InferInsertModel<typeof starTable>;
export type SelectStarTable = InferSelectModel<typeof starTable>;
