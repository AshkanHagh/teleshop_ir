import { ChevronLeft, ChevronRight, LoaderCircle, Star as StarIcon } from "lucide-react"
import Button from "../../components/ui/Button"
import { useStarContext } from "../../context/StarContext"

const StarsSelectorBox: React.FC = () => {
    const { decrementStars, incrementStars, fetchStars, isLoading, starCount, starIndex, stars, error } = useStarContext()
