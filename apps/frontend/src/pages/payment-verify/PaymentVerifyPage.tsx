...
const PaymentVerifyPage: React.FC = () => {
  ...
  const { errorMessage } = useVerifyPayment(setStatus, { Authority: queries.Authority, Status: queries.Status })

  const { icon: Icon, iconClass, description, title, hasButton, buttonClass } = statusContent[status]
        ...
        <div className="text-center">
          ...
          {status === 'success' &&
            <p className="text-gray-400 text-sm border-t">
              ...
              <span className='text-gray-600 font-semibold'> "سفارش‌های من" </span>
              بروید.
            </p>}
